...
leptosbook gives Leptos a small set of primitives for **paginated, gesture-driven
...
read the [Guide](https://github.com/andygauge/leptosbook/blob/main/GUIDE.md)
instead; if you want runnable apps, see the
[`examples/`](https://github.com/andygauge/leptosbook/tree/main/examples) directory.
